...
TRect2<PositionType, SizeType>::TRect2(const TVector2<PositionType>& position, const TSize2<SizeType>& size)
	: X(position.X), Y(position.Y), Width(size.Width), Height(size.Height)
{ }

template<typename PositionType, typename SizeType>
bool TRect2<PositionType, SizeType>::Contains(const TVector2<PositionType>& point) const
{
...
template<typename PositionType, typename SizeType>
bool TRect2<PositionType, SizeType>::Contains(const TRect2<PositionType, SizeType>& other) const
{
...
template<typename PositionType, typename SizeType>
bool TRect2<PositionType, SizeType>::Overlaps(const TRect2<PositionType, SizeType>& other) const
{
...
template<typename PositionType, typename SizeType>
void TRect2<PositionType, SizeType>::SetPosition(const TVector2<PositionType>& position)
{
	X = position.X;
	Y = position.Y;
}
...
template<typename PositionType, typename SizeType>
void TRect2<PositionType, SizeType>::SetSize(const TSize2<SizeType>& size)
{
	Width = size.Width;
	Height = size.Height;
}
...
template<typename PositionType, typename SizeType>
void TRect2<PositionType, SizeType>::Encapsulate(const TRect2& other)
{
	PositionType myRight = X + (PositionType)Width;
	PositionType myBottom = Y + (PositionType)Height;
	PositionType otherRight = other.X + (PositionType)other.Width;
...
template<typename PositionType, typename SizeType>
void TRect2<PositionType, SizeType>::Clip(const TRect2& clipRect)
{
	...
	Width = (SizeType)std::max(0, newRight - newLeft);
	Height = (SizeType)std::max(0, newBottom - newTop);
}

template<typename PositionType, typename SizeType>
u32 TRect2<PositionType, SizeType>::Cut(const TRect2& rectangleToCutWith, Array<TRect2, 4>& outPieces) const
{
	u32 cutPieceCount = 0;
...
template<typename PositionType, typename SizeType>
void TRect2<PositionType, SizeType>::Cut(const Vector<TRect2>& rectanglesToCutWith, Vector<TRect2>& pieces) const
{
	FrameScope frameScope;
	FrameVector<TRect2> temporaryPieceBuffers[2];
...
template<typename PositionType, typename SizeType>
void TRect2<PositionType, SizeType>::Transform(const Matrix4& matrix)
{
	Vector4 verts[4];
...
template<typename PositionType, typename SizeType>
template <typename T>
void TRect2<PositionType, SizeType>::AddUnique(const TRect2& area, T& inOutAreaList)
{
...
template B3D_UTILITY_EXPORT void TRect2<i32>::AddUnique(const TRect2&, Vector<TRect2>&);
template B3D_UTILITY_EXPORT void TRect2<i32, u32>::AddUnique(const TRect2&, Vector<TRect2>&);
template B3D_UTILITY_EXPORT void TRect2<float>::AddUnique(const TRect2&, Vector<TRect2>&);
template B3D_UTILITY_EXPORT void TRect2<i32>::AddUnique(const TRect2&, FrameVector<TRect2>&);
template B3D_UTILITY_EXPORT void TRect2<i32, u32>::AddUnique(const TRect2&, FrameVector<TRect2>&);
template B3D_UTILITY_EXPORT void TRect2<float>::AddUnique(const TRect2&, FrameVector<TRect2>&);
