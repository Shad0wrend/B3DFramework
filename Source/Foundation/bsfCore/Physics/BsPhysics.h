...
namespace bs
{
	...
	class BS_CORE_EXPORT B3D_SCRIPT_EXPORT(DocumentationGroup(Physics)) Physics : public Module<Physics>
	{
	public:
	 ...
	 */
	class BS_CORE_EXPORT B3D_SCRIPT_EXPORT(DocumentationGroup(Physics)) PhysicsScene
	{
	public:
		/******************************************************************************************************************/
		/************************************************* QUERIES ********************************************************/
