...
extern "C" void* LoadPlugin_bsfMetalRenderAPI()
{
	return static_cast<void*>(B3DNew<render::MetalGpuBackendFactory>());
}

extern "C" void UnloadPlugin_bsfMetalRenderAPI(void* instance)
{
