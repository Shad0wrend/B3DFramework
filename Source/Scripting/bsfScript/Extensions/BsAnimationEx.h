...
namespace bs
{
	...
	{
	public:
		BS_SCRIPT_EXPORT(ExtensionMethodForType(AnimationCurves),ExportName(Position),pr:getter)
		...
		BS_SCRIPT_EXPORT(ExtensionMethodForType(AnimationCurves),ExportName(Position),pr:setter)
		static void SetPositionCurves(const SPtr<AnimationCurves>& thisPtr, const Vector<TNamedAnimationCurve<Vector3>>& value);

		BS_SCRIPT_EXPORT(ExtensionMethodForType(AnimationCurves),ExportName(Rotation),pr:getter)
		...
		BS_SCRIPT_EXPORT(ExtensionMethodForType(AnimationCurves),ExportName(Rotation),pr:setter)
		static void SetRotationCurves(const SPtr<AnimationCurves>& thisPtr, const Vector<TNamedAnimationCurve<Quaternion>>& value);

		BS_SCRIPT_EXPORT(ExtensionMethodForType(AnimationCurves),ExportName(Scale),pr:getter)
		...
		BS_SCRIPT_EXPORT(ExtensionMethodForType(AnimationCurves),ExportName(Scale),pr:setter)
		static void SetScaleCurves(const SPtr<AnimationCurves>& thisPtr, const Vector<TNamedAnimationCurve<Vector3>>& value);

		BS_SCRIPT_EXPORT(ExtensionMethodForType(AnimationCurves),ExportName(Generic),pr:getter)
		...
		BS_SCRIPT_EXPORT(ExtensionMethodForType(AnimationCurves),ExportName(Generic),pr:setter)
	...
	public:
		...
		BS_SCRIPT_EXPORT(ExtensionMethodForType(RootMotion),ExportName(Position),pr:getter)
		...
		BS_SCRIPT_EXPORT(ExtensionMethodForType(RootMotion),ExportName(Rotation),pr:getter)
