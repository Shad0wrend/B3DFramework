...
namespace bs
{
	...
	{
	public:
		B3D_SCRIPT_TYPE_DEFINITION(kEngineAssembly, kEngineNs, "TSize2<bs::TUnitValue<int,bs::LogicalPixel>>")
	...
	{
	public:
		B3D_SCRIPT_TYPE_DEFINITION(kEngineAssembly, kEngineNs, "TSize2<bs::TUnitValue<float,bs::LogicalPixel>>")
	...
	{
	public:
		B3D_SCRIPT_TYPE_DEFINITION(kEngineAssembly, kEngineNs, "TSize2<bs::TUnitValue<int,bs::PhysicalPixel>>")
	...
	{
	public:
		B3D_SCRIPT_TYPE_DEFINITION(kEngineAssembly, kEngineNs, "TSize2<bs::TUnitValue<float,bs::PhysicalPixel>>")
