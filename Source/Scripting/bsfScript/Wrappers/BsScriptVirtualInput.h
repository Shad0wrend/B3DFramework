...
namespace bs
{
	...
	private:
		...
		static void Internal_GetOrCreateVirtualButton(MonoString* name, VirtualButton* button);
		static void Internal_GetOrCreateVirtualAxis(MonoString* name, VirtualAxis* axis);
