...
There are three non-programmable state objects in total:
 - @b3d::render::RasterizerState
 - @b3d::render::DepthStencilState
 - @b3d::render::BlendState
...
# Rasterizer state
Rasterizer state allows you to control how are 3D polygons, lines or points converted to 2D pixels. You can create it by filling out the @b3d::RASTERIZER_STATE_DESC structure and passing it to @b3d::render::RasterizerState::create.
...
# Depth-stencil state
Depth-stencil state allows you to control how are depth and/or stencil buffers modified during rendering. You can create it by filling out the @b3d::DEPTH_STENCIL_STATE_DESC structure and passing it to @b3d::render::DepthStencilState::create.
...
# Blend state
Blend state allows to you to control how is a rendered pixel blended with any previously rendered pixels. You can create it by filling out the @b3d::BLEND_STATE_DESC structure and passing it to @b3d::render::BlendState::create. Most of blend state options can be controlled individually for up to 8 render targets.
